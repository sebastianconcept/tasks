...
smalltalk.MaplessModel.comment="This is the model parent"
smalltalk.addMethod(
smalltalk.method({
selector: "=",
category: 'reactions',
...
args: [],
source: "initialize\x0a\x0a\x09super initialize.\x0a\x0a\x09data := HashedCollection new.\x0a\x09self modelClass: self class name.\x0a\x09self initializeInstanceVersion\x09",
...
args: ["aBlock"],
source: "saveDo: aBlock\x0a\x0a\x09jQuery ajax: #{ \x0a\x09\x09'url' -> self path.\x0a\x09\x09'type' -> 'PUT'.\x0a\x09\x09'cache' -> false.\x0a\x09\x09'data' -> self asJSONString.\x0a\x09\x09'success' -> [:x| self onAfterSave: x done: aBlock].\x0a\x09\x09'fail' -> [:x| self onSaveFail: x].\x0a\x09\x09'error' -> [:x| self onSaveFail: x]}  \x0a\x0a\x0a",
